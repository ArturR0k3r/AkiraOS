...
typedef struct {
    ...
    akira_gpio_dir_t dir;   /**< Direction */
...
typedef struct {
    ...
    akira_gpio_config_t cs;     /**< Chip select GPIO */
} akira_spi_config_t;
...
typedef struct {
    ...
    akira_i2c_speed_t speed;    /**< Bus speed */
} akira_i2c_config_t;
...
/** GPIO handle */
typedef struct akira_gpio akira_gpio_t;

/** SPI handle */
typedef struct akira_spi akira_spi_t;

/** I2C handle */
typedef struct akira_i2c akira_i2c_t;
 ...
 */
typedef void (*akira_gpio_callback_t)(akira_gpio_t *gpio, uint8_t pin, 
                                       void *user_data);
