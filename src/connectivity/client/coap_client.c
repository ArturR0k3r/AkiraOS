...
{
    switch (code) {
    case COAP_CODE_CREATED:     return "2.01 Created";
    case COAP_CODE_DELETED:     return "2.02 Deleted";
    case COAP_CODE_VALID:       return "2.03 Valid";
    case COAP_CODE_CHANGED:     return "2.04 Changed";
    case COAP_CODE_CONTENT:     return "2.05 Content";
    case COAP_CODE_BAD_REQUEST: return "4.00 Bad Request";
    case COAP_CODE_UNAUTHORIZED: return "4.01 Unauthorized";
    case COAP_CODE_FORBIDDEN:   return "4.03 Forbidden";
    case COAP_CODE_NOT_FOUND:   return "4.04 Not Found";
    case COAP_CODE_NOT_ALLOWED: return "4.05 Method Not Allowed";
    case COAP_CODE_INTERNAL_ERR: return "5.00 Internal Server Error";
    case COAP_CODE_NOT_IMPL:    return "5.01 Not Implemented";
    case COAP_CODE_UNAVAILABLE: return "5.03 Service Unavailable";
